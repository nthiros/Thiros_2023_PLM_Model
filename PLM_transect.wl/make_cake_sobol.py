...
par_priors =   {'dz_soil':    4,                 # tickness of soil layer in meters
                'dz_wshale':  4,                 # thicknes of w.shale layer in meters
                
                'K_soil':     np.log10(5.605e-05),   # log10 K (m/s)
                #'K_wshale':   np.log10(5.605e-06),  # log10 K
                #'K_fshale':   np.log10(5.605e-08),  # log10 K
                ...
                'K_fshale_f': -2.0,                  # log-factor decrease on K_wshale for top of K_fshale
...
# Only these parameters will be varied
...
par_bounds =   {'dz_soil':    [2,  4],       # thickness of soil layer
                ...
                'K_soil':     [-6.3,  -4.3],   # log10 K (m/s)
                #'K_wshale':   [-7.0,  -5.0],  # log10 K
                #'K_fshale':   [-12.0, -6.0],  # log10 K
                'K_wshale_f': [-2.0, 0.0],     # factor decrease (log-space) of K_wshale from K_soil. ie. log_kwshale=log_ksoil-1.0
                'K_fshale_f': [-2.0, 0.0],     # factor decrease (log-space) of K_fshale from K_wshale. ie. log_fwshale=log_wshale-0.0 (same)
                ...
                'por_soil':   [0.25, 0.4],    # porosity
                'por_wshale': [0.1,  0.3],    # porosity
                'por_fshale': [0.01, 0.1],    # porosity
                
                'soil_rel_alpha':   [1.0,  3.5],   # vg alpha
                'wshale_rel_alpha': [0.5,  2.0],   # vg alpha
...
num_runs = 100        # the number of training instances to generate
random_state = 22133
