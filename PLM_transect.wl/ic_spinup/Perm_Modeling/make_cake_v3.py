...
# top starts at zero 
# make multipliers of 2.0m
layers_dbs = {}
layers_dbs['soil1']   = 4.5
layers_dbs['soil2']   = 5.0
layers_dbs['wshale']  = 9.0
...
layers_K['fshale']  = 5.605e-08 

# Porosity
layers_por = {}
layers_por['soil1']   = 0.40
layers_por['soil2']   = 0.20
layers_por['wshale']  = 0.10
layers_por['fshale']  = 0.05
...
layers_srel = {}
layers_srel['soil1']   = [1.820, 1.789, 0.131, 1.0]
layers_srel['soil2']   = [2.101, 1.686, 0.07,  1.0]
layers_srel['wshale']  = [0.519, 1.595, 0.04,  1.0]
layers_srel['fshale']  = [0.519, 1.595, 0.005, 1.0]
...
np.savetxt('subsurface_lc102a0.sa', z_, fmt='%.4e', header='559 1 32', comments='')
