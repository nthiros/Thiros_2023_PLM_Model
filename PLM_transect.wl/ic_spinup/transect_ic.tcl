# Initial conditions run, the spinup for the spinup
...
pfset Patch.z-upper.BCPressure.alltime.Value         -4.0E-05
...
pfset Solver.Nonlinear.MaxIter				40000
...
pfset Solver.Linear.MaxIter				1500000
...
pfset Geom.domain.ICPressure.Value 		   -8.0
