# Transient simulation from wy 2000 to 2016
...
# File Copies
#---------------------------------------------------------
set met_fname "met.2000-2016.1hr.txt"
set ind_fname "subsurface_00037.pfb"
set mat_fname "subsurface_00037.mat"

set ip_dir  "wy_spinup"
set ip_fname   "wy_spinup.out.press.03650.pfb"
...
exec cp ../../clm_inputs/drv_clmin_shrub.dat.restart.counter ./drv_clmin.dat
...
#-----------------------------------------------------------------------------
# Units are hours
# wy2000 throuh wy2016 = 17 years
# set runlength as number of rows in MET forcing data
set runlength 149040
